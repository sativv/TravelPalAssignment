        ...
        private void FillTravelList()
        {
            ...
            foreach (Travel travel in TravelManager.Travels)
            {
                ...
                if (travel.OwnedUser.Username == UserManager.SignedInUser.Username)
                {
                    ...
                    listViewItem.Content = "To  -  " + travel.Countries.ToString() + "  |  " + travel.GetType().Name;
                ...
                else if (UserManager.SignedInUser is Admin)
                {
                    ListViewItem listViewItem = new ListViewItem();
                    listViewItem.Tag = travel;
                    listViewItem.Content = "To  -  " + travel.Countries.ToString() + "  |  " + travel.GetType().Name + "  -  " + travel.OwnedUser.Username;
                    lstTravelList.Items.Add(listViewItem);
                }
